...
public class TestValid_2 extends BaseSetup{
	LoginMail le;
	LoginPassword lp;
	LoginOTP lo;
	LoginRem lr;
	...
	public void Test() throws Exception {
		logger = report.createTest("Automation By Manisha Kumari 873197");
	...
	public Object[][] invalidcaseData() {
		Object[][] arrayObject = getExcelData(System.getProperty("user.dir") +"\\MainSpring Testing.xlsx","valid_2",5,8);
		return arrayObject;
	}
}
