...
public class TestInvalid_1 extends BaseSetup{
	LoginMail le;
	LoginPassword lp;
	LoginOTP lo;
	LoginRem lr;
	...
	public void Test() throws Exception {
		logger = report.createTest("Automation By Abhishek Choudhary 873154");
	...
	public Object[][] invalidcaseData() {
		Object[][] arrayObject = getExcelData(System.getProperty("user.dir") +"\\MainSpring Testing.xlsx","invalid_1",5,8);
		return arrayObject;
	}
}
