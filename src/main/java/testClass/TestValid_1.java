...
public class TestValid_1 extends BaseSetup{
	LoginMail le;
	LoginPassword lp;
	LoginOTP lo;
	LoginRem lr;
	...
	public void Test() throws Exception {
		logger = report.createTest("Automation By R.K.Barath 873197");
	...
	public Object[][] invalidcaseData() {
		Object[][] arrayObject = getExcelData(System.getProperty("user.dir") +"\\MainSpring Testing.xlsx","valid_1",4,8);
		return arrayObject;
	}
}
