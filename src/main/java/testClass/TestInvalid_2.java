...
public class TestInvalid_2 extends BaseSetup{
	LoginMail le;
	LoginPassword lp;
	LoginOTP lo;
	LoginRem lr;
	...
	public void Test() throws Exception {
		logger = report.createTest("Automation By Shashank Thakur 873142");
	...
	public Object[][] invalidcaseData() {
		Object[][] arrayObject = getExcelData(System.getProperty("user.dir") +"\\MainSpring Testing.xlsx","invalid_2",5,8);
		return arrayObject;
	}
}
